...
from resk_llm.core.abc import RESK_UtilityBase

# Type de configuration pour TextAnalyzer
TextAnalyzerConfig = Dict[str, Any]

class RESK_TextAnalyzer(RESK_UtilityBase, DetectorBase[str, TextAnalyzerConfig]):
    """Text analyzer utility for RESK-LLM."""
    """
