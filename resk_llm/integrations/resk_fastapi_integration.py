...
from resk_llm.patterns.emoji_patterns import check_for_obfuscation, sanitize_text_from_obfuscation
from resk_llm.patterns.llm_injection_patterns import check_text_for_injections
from resk_llm.patterns.pii_patterns import check_pii_content
from resk_llm.patterns.toxic_content_patterns import moderate_text
...
class FastAPIProtector(ProtectorBase[Any, Any, FastAPIProtectorConfig]):
    ...
    def __init__(self, 
        ...
        if self.custom_patterns_dir:
            ...
            self.word_list_filter = RESK_WordListFilter()
