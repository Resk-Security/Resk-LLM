...
class PromptSecurityManager(SecurityManagerBase[str, str, SecurityManagerConfig]):
    ...
    def __init__(
        ...
        self.heuristic_filter: Optional[RESK_HeuristicFilter] = None
        self.vector_db: Optional[RESK_VectorDatabase] = None
        ...
        if self.enable_heuristic_filter:
            ...
            self.heuristic_filter = RESK_HeuristicFilter(config=heuristic_config)
        ...
        if self.embedding_function is not None:
            ...
            self.vector_db = RESK_VectorDatabase(
